...
[
	["",true],
		["Patrol_Pack - 10", [2],  "", -5, [["expression", format[_EXECscript3,"patrol.sqf"]]], "1", "1"],
		["Assault_Pack - 12", [3],  "", -5, [["expression", format[_EXECscript3,"assault.sqf"]]], "1", "1"],
		["TerminalPack - 15", [4],  "", -5, [["expression", format[_EXECscript3,"terminal.sqf"]]], "1", "1"],
		["Survival ACU - 22", [5],  "", -5, [["expression", format[_EXECscript3,"survival.sqf"]]], "1", "1"],
		["CompactPack - 25", [6],  "", -5, [["expression", format[_EXECscript3,"compact.sqf"]]], "1", "1"],
		["CivilBackpack - 40", [7],  "", -5, [["expression", format[_EXECscript3,"civil.sqf"]]], "1", "1"],
		["Coyote Backpack - 50", [8],  "", -5, [["expression", format[_EXECscript3,"coyote.sqf"]]], "1", "1"],
		["LargeGunBag - 60", [9],  "", -5, [["expression", format[_EXECscript3,"gunbag.sqf"]]], "1", "1"],
		["", [-1], "", -5, [["expression", ""]], "1", "0"],
			["Next page", [12], "#USER:WeaponMenu3", -5, [["expression", ""]], "1", "1"],
			["Exit", [13], "", -3, [["expression", ""]], "1", "1"]
];
